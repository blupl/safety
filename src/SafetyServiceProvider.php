<?php namespace Blupl\Safety;

use Orchestra\Safety\Providers\ServiceProvider;
...
//        $this->app->bind('Orchestra\Control\Contracts\Command\Synchronizer', 'Orchestra\Control\Command\Synchronizer');
    ...
    public function boot()
    {
        ...
        $this->addConfigComponent('blupl/safety', 'blupl/safety', $path.'/resources/config');
        $this->addLanguageComponent('blupl/safety', 'blupl/safety', $path.'/resources/lang');
        $this->addViewComponent('blupl/safety', 'blupl/safety', $path.'/resources/views');
...
//    }
    ...
    {
        $this->app['events']->listen('orchestra.ready: admin', 'Blupl\Safety\Http\Handlers\SafetyMenuHandler');
    }
...
//    }
    ...
    {
        $this->app['orchestra.extension.config']->map('blupl/safety', [
